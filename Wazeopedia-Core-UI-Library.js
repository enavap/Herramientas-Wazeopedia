    ...
    window.WazeopediaUI = (function() {
        ...
        function loadStyles() {
            const css = `
                ...
                .wz-bio-entry-preview, .wz-faq-entry-preview { margin-top: 5px; padding: 8px; background-color: #f0f0f0; color: #333; border: 1px dashed #ccc; border-radius: 4px; font-size: 0.9em; white-space: pre-wrap; line-height: 1.4; }
                ...
                .wz-faq-entry-preview blockquote { border-left: 3px solid #ccc; margin-left: 0; padding-left: 10px; color: #666; }
                ...
                .wz-dark-mode .wz-faq-entry-preview blockquote { border-left-color: #666; color: #ccc; }
            `;
                ...
                const buttonActions = {
                    ...
                    'link': { label: '🔗', title: 'Hipervínculo', action: () => {
                        ...
                        modalContent.querySelector('.wz-confirm').onclick = () => {
                            ...
                            if (url) { const linkText = title || url; const textToInsert = `[${linkText}](${url})`; publicApi.insertTextAtCursor(textarea, textToInsert, { select: !selectedText }); }
                            closeThisModal();
                        };
